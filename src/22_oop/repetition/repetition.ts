...
const newOrder3: OrderWithEnum = {
  customerName: "Max Muster3",
  status: OrderStatus.Angelegt,
};
...
const numberedFruits2 = fruits2.map(
  (fruit: string, index: number) => `${index + 1}. ${fruit}`
);
